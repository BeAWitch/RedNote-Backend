...
@Slf4j
@Service("zhiPuNoteOptimizationAdapter")
@RequiredArgsConstructor
public class ZhiPuNoteOptimizationAdapter implements IAiNoteOptimizationService {
    ...
    public AIResponseVO optimizeNote(AINoteOptimizeRequestDTO request) {
        log.info("ZhiPu 笔记优化服务调用开始 - 用户ID: {}", request.getUserId());
        ...
        try {
            ...
            log.info("ZhiPu 笔记优化服务调用结束 - 用户ID: {}", request.getUserId());
        }
    }
    ...
    private AIResponseVO buildSuccessResponse(ChatResponse chatResponse, Instant startTime, AINoteOptimizeRequestDTO request) {
        ...
        log.info("ZhiPu 笔记优化调用成功 - 用户ID: {}, 响应时间: {}ms, 优化内容长度: {}",
