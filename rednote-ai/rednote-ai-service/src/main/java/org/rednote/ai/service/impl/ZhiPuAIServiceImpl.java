...
public class ZhiPuAIServiceImpl implements IZhiPuAIService {

    private final ZhiPuAiChatModel chatModel;

    @Override
    public AIResponseVO generate(AIRequestDTO aiRequestDTO) {
        log.info("AI 服务调用开始 - 用户ID: {}", aiRequestDTO.getUserId());
        ...
        try {
            ...
            log.info("AI 服务调用结束 - 用户ID: {}", aiRequestDTO.getUserId());
        }
    }
    ...
    private AIResponseVO buildSuccessResponse(ChatResponse chatResponse, Instant startTime, AIRequestDTO request) {
        ...
        log.info("AI 服务调用成功 - 用户ID: {}, 响应时间: {}ms, 内容长度: {}",
